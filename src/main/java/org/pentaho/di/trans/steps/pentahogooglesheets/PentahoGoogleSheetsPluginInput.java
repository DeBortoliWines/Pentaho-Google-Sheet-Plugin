  ...
  /**
   ...
   public boolean init( StepMetaInterface smi, StepDataInterface sdi ) {
		...
		if (super.init(smi, sdi)) {
            try {				
				Sheets service = new Sheets.Builder(HTTP_TRANSPORT, JSON_FACTORY, PentahoGoogleSheetsPluginCredentials.getCredentialsJson(scope,environmentSubstitute(meta.getJsonCredentialPath()), HTTP_TRANSPORT, JSON_FACTORY)).setApplicationName(APPLICATION_NAME).build();
